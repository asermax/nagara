...
async def advance_queued_item(item_id: str) -> None:
    ...
    Enrichment is not built yet, so this fetches and segments and sets enriched_at in the
    same write as the spawn. Later quests plug enrichment steps into the gap between
    segment and spawn without rebuilding the path.
    """
