...
Reloading the page restores playback to the position last reached. That position is stored in the browser's local storage, keyed by item; it does not follow a listener across devices.
